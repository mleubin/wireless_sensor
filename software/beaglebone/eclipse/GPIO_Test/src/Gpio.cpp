...
const std::string PinNames[] = { "P8_3", "P8_4", "P8_5", "P8_6", "P8_7", "P8_8",
		"P8_9", "P8_10", "P8_11", "P8_12", "P8_13", "P8_14", "P8_15", "P8_16",
		"P8_17", "P8_18", "P8_19", "P8_20", "P8_21", "P8_22", "P8_23", "P8_24",
		"P8_25", "P8_26", "P8_27", "P8_28", "P8_29", "P8_30", "P8_31", "P8_32",
		"P8_33", "P8_34", "P8_35", "P8_36", "P8_37", "P8_38", "P8_39", "P8_40",
...
Gpio::Gpio(BB_PIN Pin, DIRECTION Dir, Gpio::STATE State) :
		m_Pin(Pin), m_Dir(Dir) {
	// TODO: throw exceptions, if failed
	enable();
	setDir();
...
Gpio::STATE Gpio::getState() {
	...
	if (m_Dir == OUT) {
		std::cout << "Warning: read state on GPIO configured as output"
				<< std::endl;
	}
...
bool Gpio::toggle() {
	...
	case HIGH:
		return setState(LOW);
	default:
		std::cout << "Warning: trying to toggle pin with unknown state"
				<< std::endl;
		return false;
	}
}
...
bool Gpio::setInterrupt(Gpio::CHANGE Change) {
	...
	if (res < 0) {
		std::cout << "Error: failed to set GPIO interrupt edge direction"
				<< std::endl;
		return false;
	}
